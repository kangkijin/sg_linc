...
//		sSearch: "검색:",
	...
	fnDrawCallback :function(oSettings) {// 각 JSP에 fnDrawCallback 지정 안 할 경우 아래가 디폴트로 실행됨
		...
		// datatables 열 깨짐 현상 방지
		$("#"+$(this).attr("id")).DataTable().columns.adjust();
	}
});
...
fn_DTbtnAllCreate = function(_title, _text, _colLength, _excludeColIdxArr){
	var _colArr = [];	// 컬럼 배열
...
var _rtnArr = [
	...
	},*/
	{
		extend: "excelHtml5",
		title: _title,
		text: "<i class='fa fa-file-excel-o'></i>&nbsp;" + _text,
		exportOptions: {
			columns : _colArr
		},
		customize: function( xlsx ) {
